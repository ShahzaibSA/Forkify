...
class RecipeView extends View {
  ...
  _errorMessage = "We could'nt find that recipe. Please try anthore one!";
  ...
  _generateHtml() {
    ...
    // console.log(this._data.cooking_time);
    return `
    ...
    <div class="recipe__details">
      ...
      <div class="recipe__info">
        ...
        <div class="recipe__info-buttons">
          <button class="btn--tiny btn-update-servings btn--increase-servings" data-update-servings="${
